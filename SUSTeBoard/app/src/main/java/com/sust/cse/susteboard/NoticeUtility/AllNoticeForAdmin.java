...
public class AllNoticeForAdmin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_all_notice_for_admin);
        ...
        progressDialog = new ProgressDialog(AllNoticeForAdmin.this, R.style.AppTheme_Dark_Dialog);
    ...
    private void parseJsonArrayResponse(JSONArray response) {
        ...
        for (int i = response.length(); i >= 0; i--) {
            ...
            //ArrayAdapter<String> adapter = new ArrayAdapter<String>(context, android.R.layout.simple_list_item_1, noticeList);
        ...
        inputSearch.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence cs, int arg1, int arg2, int arg3) {
                ...
                AllNoticeForAdmin.this.adapter.getFilter().filter(cs);
            }
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent in = new Intent(AllNoticeForAdmin.this, NoticeDetails.class);
                in.putExtras(bundle);
                startActivity(in);
            }
        });
        ...
        protected void onPreExecute() {
            ...
            request = new JsonArrayRequest(url, new Response.Listener<JSONArray>() {
                ...
                public void onResponse(JSONArray response) {
                    ...
                    //Toast.makeText(AllNoticeForAdmin.this, "Success", Toast.LENGTH_LONG).show();
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    //Toast.makeText(AllNoticeForAdmin.this, "Not Success", Toast.LENGTH_LONG).show();
    ...
    public void alartDialog(String msg){
        AlertDialog.Builder builder1 = new AlertDialog.Builder(AllNoticeForAdmin.this);
