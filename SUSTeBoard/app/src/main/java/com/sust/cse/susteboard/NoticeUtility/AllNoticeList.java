...
public class AllNoticeList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(AllNoticeList.this, R.style.AppTheme_Dark_Dialog);
    ...
    private void parseJsonArrayResponse(JSONArray response) {
        ...
        Log.d("simul", String.valueOf(noticeList.size()));
        ...
        inputSearch.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence cs, int arg1, int arg2, int arg3) {
                ...
                AllNoticeList.this.adapter.getFilter().filter(cs);
            }
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent in = new Intent(AllNoticeList.this, NoticeDetails.class);
                in.putExtras(bundle);
                startActivity(in);
            }
        });
        ...
        protected void onPreExecute() {
            ...
            request = new JsonArrayRequest(url, new Response.Listener<JSONArray>() {
                ...
                public void onResponse(JSONArray response) {
                    ...
                    //Toast.makeText(AllNoticeList.this, "Success", Toast.LENGTH_LONG).show();
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    //Toast.makeText(AllNoticeList.this, "Not Success", Toast.LENGTH_LONG).show();
    ...
    public void alartDialog(String msg){
        AlertDialog.Builder builder1 = new AlertDialog.Builder(AllNoticeList.this);
