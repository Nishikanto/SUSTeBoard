...
public class TodayNoticeList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(TodayNoticeList.this, R.style.AppTheme_Dark_Dialog);
    ...
    private void parseJsonArrayResponse(JSONArray response) {
        ...
        inputSearch.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence cs, int arg1, int arg2, int arg3) {
                ...
                TodayNoticeList.this.adapter.getFilter().filter(cs);
            }
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent in = new Intent(TodayNoticeList.this, NoticeDetails.class);
                in.putExtras(bundle);
                startActivity(in);
            }
        });
        ...
        protected void onPreExecute() {
            ...
            request = new JsonArrayRequest(url, new Response.Listener<JSONArray>() {
                ...
                public void onResponse(JSONArray response) {
                    ...
                    //Toast.makeText(TodayNoticeList.this, "Success", Toast.LENGTH_LONG).show();
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    //Toast.makeText(TodayNoticeList.this, "Not Success", Toast.LENGTH_LONG).show();
    ...
    public void alartDialog(String msg){
        AlertDialog.Builder builder1 = new AlertDialog.Builder(TodayNoticeList.this);
